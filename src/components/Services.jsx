...
const Services = () => {
  const cards = [
    {
      title: "თანამგზავრი შენს გვერდით",
      desc: "პერსონალური მხარდაჭერა პროფესიის არჩევაში",
      icon: <Globe className="text-[#f3713d] w-8 h-8 md:w-10 md:h-10" />,
    },
    {
      title: "გაიცანი საკუთარი თავი",
      desc: "ჰოლანდის ტესტი - აღმოაჩინე შენი უნარები და ინტერესები",
      icon: <UserCircle className="text-[#f3713d] w-8 h-8 md:w-10 md:h-10" />,
    },
    {
      title: "გაიცანი პროფესიები",
      desc: "Live შეხვედრები და ვორქშოპები, მოისმინე რეალური გამოცდილება და დასვი შეკითხვები",
      icon: <Briefcase className="text-[#f3713d] w-8 h-8 md:w-10 md:h-10" />,
    },
    {
      title: "აირჩიე განათლების გზა",
      desc: "სად შეგიძლია ისწავლო - უმაღლესი განათლება, პროფესიული განათლება",
