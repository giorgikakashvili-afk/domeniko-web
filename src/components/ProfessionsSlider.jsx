...
const ProfessionsSlider = () => {
  ...
  return (
    <section className="py-12 md:py-20 px-4 md:px-10 xl:px-20 overflow-hidden font-noto">
      <style>{`
        /* მასკა მუშაობს მხოლოდ მაშინ, როცა isEnd არის false */
        .fade-mask-prof {
      ...
      <div className="max-w-8xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="lg:w-2/3 relative group">
          <Swiper
            ...
            // Swiper-ის ივენთები სტეიტის სამართავად
            ...
            // თუ isEnd არის true, ვამატებთ no-mask კლასს
          ...
          <button className="prev-btn hidden md:flex absolute -left-4 md:-left-7 top-1/2 -translate-y-1/2 z-50 w-10 h-10 md:w-14 md:h-14 bg-[#0A0521] text-white rounded-full justify-center items-center shadow-xl transition-all duration-300 hover:bg-[#f3713d] [&.swiper-button-disabled]:opacity-0">
            <ArrowLeft size={24} className="md:w-7 md:h-7" />
          </button>

          <button className="next-btn hidden md:flex absolute -right-4 md:-right-7 top-1/2 -translate-y-1/2 z-50 w-10 h-10 md:w-14 md:h-14 bg-[#0A0521] text-white rounded-full justify-center items-center shadow-xl transition-all duration-300 hover:bg-[#f3713d] [&.swiper-button-disabled]:opacity-0">
